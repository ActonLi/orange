...
//#define XMPP_NS_PING "urn:ietf:params:xml:ns:ping"
...
//add by shelly
void SetXMPPServerCertificatePath(char * pFile);
void SetXMPPClientCertificatePath(char * pFile);
void SetXMPPClientPrivateKeyPath(char * pFile);
