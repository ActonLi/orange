...
typedef struct tagEventNode {
	...
	char szTimeStamp[32]; // ISO8601 format e.g 2008-02-01T09:00:22+05:00"   //The portal client must supply a local timestamp for the event. The timestamp must
						  // be compatible to the ISO 8601 format
