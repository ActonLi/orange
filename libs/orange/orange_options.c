...
static orange_option_t* lookup_short(orange_option_t** o, char n)
{
	while (*o) {
		if ((*o)->shortopt == n) {
			return *o;
...
static orange_option_t* lookup_long(orange_option_t** o, char* n)
{
	while (*o) {
...
static void apply_option(orange_option_t* o, char* arg, int l)
{
	char s[2] = {0};
...
int orange_parse_options(int* argc, char*** argv, orange_option_t** options)
{
	int				 c = 1, i = 1, j;
	char			 x;
	char *			 a, *v;
