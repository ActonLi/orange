...
static __inline size_t QUICK_SORT_PARTITION(SORT_TYPE* dst, const size_t left, const size_t right, const size_t pivot)
{
...
static __inline size_t MEDIAN(const SORT_TYPE* dst, const size_t a, const size_t b, const size_t c)
{
...
static __inline int PUSH_NEXT(SORT_TYPE* dst, const size_t size, TEMP_STORAGE_T* store, const size_t minrun, TIM_SORT_RUN_T* run_stack, size_t* stack_curr,
							  size_t* curr)
{
