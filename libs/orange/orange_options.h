...
#define OPTIONS(...) ((orange_option_t* []){__VA_ARGS__, 0})
...
#define FLAG(s, l, f, v) (&((orange_option_t){OPTION_FLAG, s, l, &(f), v, 0, 0, 0}))
...
#define FLAG_CALLBACK(s, l, c) (&((orange_option_t){OPTION_FLAG | OPTION_CALLBACK, s, l, 0, 0, 0, 0, c}))
...
#define PARAMETER(s, l, p) (&((orange_option_t){OPTION_PARAMETER, s, l, 0, 0, &(p), 0, 0}))
...
#define PARAMETER_CALLBACK(s, l, c) (&((orange_option_t){OPTION_PARAMETER | OPTION_CALLBACK, s, l, 0, 0, 0, 0, c}))

/* Like PARAMETER, but if the value is ommitted on the command line, the variable
 * will be set to v. */
#define PARAMETER_DEFAULT(s, l, p, v) (&((orange_option_t){OPTION_PARAMETER | OPTION_DEFAULT, s, l, 0, 0, &(p), v, 0}))

/* Like PARAMETER_CALLBACK, but if the value is ommitted on the command line, the
 * callback function is called with argument v. */
#define PARAMETER_DEFAULT_CALLBACK(s, l, c, v) (&((orange_option_t){OPTION_PARAMETER | OPTION_DEFAULT | OPTION_CALLBACK, s, l, 0, 0, 0, v, c}))
...
extern int orange_parse_options(int* argc, char*** argv, orange_option_t** options);
