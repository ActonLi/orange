...
void ReadCT() 
{
    ...
    res = Cli_CTRead(Client, 0, 8, &Buffer);
    if (res == 0) {
        printf("%s:%d read CT successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 16);
    }
    else {
        printf("%s:%d read CT failed.\n", __func__, __LINE__);
    }

    res = Cli_ReadArea(Client, S7AreaCT, 0, 0, 8, S7WLCounter, &Buffer);
    if (res == 0) {
        printf("%s:%d read CT successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 16);
    }
...
void ReadTM() 
{
    ...
    res = Cli_TMRead(Client, 0, 8, &Buffer);
    if (res == 0) {
        printf("%s:%d read TM successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 16);
    }
    else {
        printf("%s:%d read TM failed.\n", __func__, __LINE__);
    }

    res = Cli_ReadArea(Client, S7AreaTM, 0, 0, 8, S7WLTimer, &Buffer);
    if (res == 0) {
        printf("%s:%d read TM successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 16);
    }
...
void WriteAndReadMB() 
{
    ...
    res = Cli_MBWrite(Client, 0, 8, &buffer);
    if (res == 0) {
        printf("%s:%d write MB successful.\n", __func__, __LINE__);
    }
    else {
        printf("%s:%d write MB failed.\n", __func__, __LINE__);
    }

    res = Cli_MBRead(Client, 0, 32, &Buffer);
    if (res == 0) {
        printf("%s:%d read MB successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 32);
    }
    else {
        printf("%s:%d read MB failed.\n", __func__, __LINE__);
    }
...
void ReadEB() 
{
    ...
    res = Cli_EBRead(Client, 0, 32, &Buffer);
    if (res == 0) {
        printf("%s:%d read EB successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 32);
    }
    else {
        printf("%s:%d read EB failed.\n", __func__, __LINE__);
    }

    res = Cli_EBWrite(Client, 0, 32, &buffer);
    if (res == 0) {
        printf("%s:%d write EB successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 32);
    }
    else {
        printf("%s:%d write EB failed.\n", __func__, __LINE__);
    }
...
void ReadAB() 
{
    ...
    res = Cli_ABRead(Client, 0, 32, &Buffer);
    if (res == 0) {
        printf("%s:%d read AB successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 32);
    }
    else {
        printf("%s:%d read AB failed.\n", __func__, __LINE__);
    }

    res = Cli_ABWrite(Client, 0, 16, &buffer);
    if (res == 0) {
        printf("%s:%d write AB successful.\n", __func__, __LINE__);
    }
    else {
        printf("%s:%d write AB failed.\n", __func__, __LINE__);
    }
...
void ReadDB(void)
{
    ...
    res = Cli_DBRead(Client, 1, 0, 512, &Buffer);
    if (res == 0) {
        printf("%s:%d read DB successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 512);
    }
    else {
        printf("%s:%d read DB failed.\n", __func__, __LINE__);
    }
    ...
    *a = ntohl(100);
    ...
    res = Cli_DBWrite(Client, 1, 0, 4, &Buffer);
    if (res == 0) {
        printf("%s:%d read DB successful.\n", __func__, __LINE__);
    }
    else {
        printf("%s:%d read area failed.\n", __func__, __LINE__);
    }

    *a = ntohl(200);

    res = Cli_DBWrite(Client, 1, 4, 4, &Buffer);
    if (res == 0) {
        printf("%s:%d read DB successful.\n", __func__, __LINE__);
    }
    else {
    ...
    *a = ntohl(300);
    ...
    res = Cli_DBWrite(Client, 1, 24, 4, &Buffer);
    if (res == 0) {
        printf("%s:%d read DB successful.\n", __func__, __LINE__);
    }
    else {
    ...
    *a = ntohl(400);
    ...
    res = Cli_DBWrite(Client, 1, 36, 4, &Buffer);
    if (res == 0) {
        printf("%s:%d read DB successful.\n", __func__, __LINE__);
    }
    else {
    ...
    *a = ntohl(500);
    ...
    res = Cli_DBWrite(Client, 1, 100, 4, &Buffer);
    if (res == 0) {
        printf("%s:%d read DB successful.\n", __func__, __LINE__);
    }
    else {
    ...
    *a = ntohl(600);
    ...
    res = Cli_DBWrite(Client, 1, 104, 4, &Buffer);
    if (res == 0) {
        printf("%s:%d read DB successful.\n", __func__, __LINE__);
    }
    else {
    ...
    *b = ntohs(78);
    ...
    res = Cli_DBWrite(Client, 1, 330, 2, &Buffer);
    if (res == 0) {
        printf("%s:%d read DB successful.\n", __func__, __LINE__);
    }
    else {
...
void ReadArea(void) 
{
    ...
    res = Cli_ReadArea(Client, S7AreaDB, 43, 0, 3, S7WLReal, &Buffer);
    if (res == 0) {
        printf("%s:%d read area successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 32);
    }
    else {
        printf("%s:%d read area failed.\n", __func__, __LINE__);
...
void WriteS7200(void) 
{
    int res;
    int i;
    unsigned char buffer[32] = {0x7f};

    /* process output */
    res = Cli_ABRead(Client, 0, 4, &Buffer);
    if (res == 0) {
        printf("%s:%d read AB successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 4);
    }
    ...
    res = Cli_ABWrite(Client, 0, 4, &buffer);
    if (res == 0) {
        printf("%s:%d write AB successful.\n", __func__, __LINE__);
    }
    else {
    ...
    /* process output */
    res = Cli_EBRead(Client, 0, 4, &Buffer);
    if (res == 0) {
        printf("%s:%d read EB successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 4);
    }
    ...
    res = Cli_EBWrite(Client, 0, 4, &buffer);
    if (res == 0) {
        printf("%s:%d write EB successful.\n", __func__, __LINE__);
        hexdump(&Buffer, 4);
    }
    ...
    res = Cli_MBWrite(Client, 0, 32, &buffer);
    if (res == 0) {
        printf("%s:%d write MB successful.\n", __func__, __LINE__);
    }
    else {
    ...
    res = Cli_DBWrite(Client, 1, 0, 512, &Buffer);
    if (res == 0) {
        printf("%s:%d write MB successful.\n", __func__, __LINE__);
    }
    else {
