...
enum logger_framing { LGR_FRAMING_NL = 0, LGR_FRAMING_SYSLOG = 1, LGR_FRAMING_SYSLOG_OC = 2, LGR_FRAMING_SYSLOG_NL = 3 };

enum logger_protocol { LGR_UDP, LGR_TCP, LGR_UNIX_DGRAM, LGR_UNIX_STREAM, LGR_STDOUT, LGR_STDERR, LGR_FILE };
